...
//        myZoo.displayAnimals();
        ...
        try {
            myZoo.addAnimal(lion);
            myZoo.addAnimal(dog);
            myZoo.addAnimal(new Animal("Husky", "Pika", -1, true));
        } catch (InvalidAgeException e) {
            System.out.println("Erreur : L'âge de l'animal est négatif.");
        } catch (ZooFullException e) {
            System.out.println("Erreur : Le zoo est plein, l'animal ne peut pas être ajouté.");
        }
